...
Here's where I made things fast - the similarity calculations (comparing all products against each other) can get really slow with lots of products. So I wrote the heavy math parts in Cython, which compiles to C code and runs way faster than pure Python. Specifically, I optimized:
